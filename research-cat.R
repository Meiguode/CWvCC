#TREEMAP
# install.packages(c("readxl","treemapify","dplyr","stringr","ggplot2"))
library(readxl)
library(treemapify)
library(dplyr)
library(stringr)
...
# Plot with bigger text, clear spacing, and flipped vertically
